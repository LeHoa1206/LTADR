...
public class page9_Trangchu_Nam extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.page9_cosmetic_nam); // Đảm bảo layout này tồn tại
        ...
        btnhomeButton.setOnClickListener(view -> {
            Intent intent = new Intent(page9_Trangchu_Nam.this, menu.class);
            startActivity(intent);
        });
        nam.setOnClickListener(view -> {
            Intent intent = new Intent(page9_Trangchu_Nam.this, page9_Trangchu_Nam.class);
            startActivity(intent);
        });
        nu.setOnClickListener(view -> {
            Intent intent = new Intent(page9_Trangchu_Nam.this, page8_Trangchu_Nu.class);
            startActivity(intent);
        });
        phukien.setOnClickListener(view -> {
            Intent intent = new Intent(page9_Trangchu_Nam.this, page11_Trangchu.class);
            startActivity(intent);
        });
        lamdep.setOnClickListener(view -> {
            Intent intent = new Intent(page9_Trangchu_Nam.this, page12_Trangchu.class);
            startActivity(intent);
        });
        getSanPhamBanChay();
...
//         Thiết lập sự kiện cho nút quay lại
    ...
    private void getSanPhamNoiBac() {
        ...
        Call<List<SanPham>> call = apiService.getAllSPDeXuatNam();  // Lấy dữ liệu ApiResponse
