...
public class page8_Trangchu_Nu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.page8_cosmetic_nu); // Đảm bảo layout này tồn tại
        ...
        btnhomeButton.setOnClickListener(view -> {
            Intent intent = new Intent(page8_Trangchu_Nu.this, menu.class);
            startActivity(intent);
        });
        nam.setOnClickListener(view -> {
            Intent intent = new Intent(page8_Trangchu_Nu.this, page9_Trangchu_Nam.class);
            startActivity(intent);
        });
        nu.setOnClickListener(view -> {
            Intent intent = new Intent(page8_Trangchu_Nu.this, page8_Trangchu_Nu.class);
            startActivity(intent);
        });
        phukien.setOnClickListener(view -> {
            Intent intent = new Intent(page8_Trangchu_Nu.this, page11_Trangchu.class);
            startActivity(intent);
        });
        lamdep.setOnClickListener(view -> {
            Intent intent = new Intent(page8_Trangchu_Nu.this, page12_Trangchu.class);
            startActivity(intent);
        });
        getSanPhamBanChay();
...
//         Thiết lập sự kiện cho nút quay lại
    ...
    private void getSanPhamNoiBac() {
        ...
        Call<List<SanPham>> call = apiService.getAllSPDeXuatNu();  // Lấy dữ liệu ApiResponse
