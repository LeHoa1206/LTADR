...
public class page8_Trangchu_Nam extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnhomeButton.setOnClickListener(view -> {
            Intent intent = new Intent(page8_Trangchu_Nam.this, page10_Trangchu.class);
            startActivity(intent);
        });
        img_menu.setOnClickListener(view -> {
            Intent intent = new Intent(page8_Trangchu_Nam.this, menu.class);
            startActivity(intent);
        });
        nam.setOnClickListener(view -> {
            Intent intent = new Intent(page8_Trangchu_Nam.this, page8_Trangchu_Nam.class);
            startActivity(intent);
        });
        nu.setOnClickListener(view -> {
            Intent intent = new Intent(page8_Trangchu_Nam.this, page9_Trangchu_Nu.class);
            startActivity(intent);
        });
        phukien.setOnClickListener(view -> {
            Intent intent = new Intent(page8_Trangchu_Nam.this, page11_Trangchu.class);
            startActivity(intent);
        });
